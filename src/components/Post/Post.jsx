...
const Post = ({ img_url, author, likes, post_id, is_liked }) => {
  ...
  const handleLike = async (postid) => {
    //await axios.post(`http://localhost:8080/likes`, { username, id: postid });
  };
...
//   };
  ...
  return (
    <div className="post">
      ...
      <img src={img_url} alt="post" className="post__img" />
